...
describe('Applicant Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'applicant', component: ApplicantComponent }]), HttpClientTestingModule],
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.applicants?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });

  describe('trackId', () => {
    it('Should forward to applicantService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getApplicantIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getApplicantIdentifier).toHaveBeenCalledWith(entity);
