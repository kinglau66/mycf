...
import { EntityArrayResponseType, ApplicantService } from '../service/applicant.service';
...
export class ApplicantComponent implements OnInit {
  ...
  trackId = (_index: number, item: IApplicant): number => this.applicantService.getApplicantIdentifier(item);
  ...
  protected onResponseSuccess(response: EntityArrayResponseType): void {
    ...
    this.applicants = this.refineData(dataFromBody);
  }

  protected refineData(data: IApplicant[]): IApplicant[] {
