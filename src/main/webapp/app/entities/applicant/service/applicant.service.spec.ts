...
import { ApplicantService, RestApplicant } from './applicant.service';

const requireRestSample: RestApplicant = {
  ...sampleWithRequiredData,
  createdDt: sampleWithRequiredData.createdDt?.format(DATE_FORMAT),
};
