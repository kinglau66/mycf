...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, com.king.mycf.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, com.king.mycf.repository.UserRepository.USERS_BY_EMAIL_CACHE);
            createCache(cm, com.king.mycf.domain.User.class.getName());
            createCache(cm, com.king.mycf.domain.Authority.class.getName());
            createCache(cm, com.king.mycf.domain.User.class.getName() + ".authorities");
            createCache(cm, com.king.mycf.domain.Applicant.class.getName());
            createCache(cm, com.king.mycf.domain.LoanRequirement.class.getName());
