...
class PaymentResourceIT {
    ...
    void putNewPayment() throws Exception {
        ...
        updatedPayment.paymentAmount(UPDATED_PAYMENT_AMOUNT).paymentType(UPDATED_PAYMENT_TYPE).paymentDate(UPDATED_PAYMENT_DATE);
    ...
    void partialUpdatePaymentWithPatch() throws Exception {
        ...
        partialUpdatedPayment.paymentType(UPDATED_PAYMENT_TYPE);
    ...
    void fullUpdatePaymentWithPatch() throws Exception {
        ...
        partialUpdatedPayment.paymentAmount(UPDATED_PAYMENT_AMOUNT).paymentType(UPDATED_PAYMENT_TYPE).paymentDate(UPDATED_PAYMENT_DATE);
